...
<div class="col-12 mb-3">
    <h4>Many to Many</h4>
    <p class="text-gray">This feature helps detect plagiarism of many documents against many documents</p>
    <hr>
</div>
...
<div class="grid col-8">
    <div class="grid-body p-0">
        <div class="item-wrapper">
            ...
            <form method="post" action="/manytomany" enctype="multipart/form-data">
                @csrf
