...
@section('title', 'One To Many | Detail')
...
<div class="container mb-5">
    <div class="box">
        ...
        <div class="col text-center">
            <a href="{{url('onetomany')}}"><button class="btn btn-dark" type="button" href="">
...
<div class="container mt-5">
    <div class="col-12">
        <h4 class="mb-3">Detail <i class="mdi mdi-information-outline"></i></h4>
        <div class="alert alert-dark" role="alert">
            <span class="font-weight-bold">Source: </span>{{$judul1}}
        </div>

        <div class="alert alert-dark" role="alert">
            <span class="font-weight-bold">Target: </span>{{$judul2}}
        </div>
        <hr>
    </div>
